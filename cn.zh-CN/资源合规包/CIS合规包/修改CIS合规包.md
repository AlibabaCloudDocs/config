...
3.  在**合规包**页面，单击目标CIS合规包名称对应**操作**列的**编辑**。

4.  在**CIS合规检查**页面，设置CIS合规检查的风险等级和规则参数。
...
4.  在目标账号组页签，单击目标CIS合规包名称对应**操作**列的**编辑**。

5.  在**CIS合规检查**页面，设置CIS合规检查的风险等级和规则参数。
